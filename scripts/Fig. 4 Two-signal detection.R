...
load(file = 'Data for figure 4.RData')
...
png('../Figures/Fig. 6 two-signal detection_globe.png', width = 8, height = 8, res = 400, units = 'in')
F1[[1]] + F1[[2]] + F1[[3]] + F1[[4]] + plot_layout(nrow = 2)
dev.off()
